    ...
    <main class="auth">
        ...
        <section class="auth__panel auth__panel--form">
            <div class="auth__card">
                ...
                <form class="form" method="post" action="modules/auth/login.php" autocomplete="off">
                    <label class="field">
                ...
                <p class="auth__hint">Belum punya akun? <a class="link" href="index.php?page=register">Register</a></p>
            </div>
        </section>
    </main>
</body>
